...
function retrieveIdentity(mantle){
    ...
    script.src = 'https://marvel.wikia.com/api.php?format=json&action=query&prop=revisions&rvprop=content&rvsection=0&callback=parseWiki'
                 + '&titles=' + encodeURIComponent(mantle);

                 
    scriptDiv = document.getElementById('identity');
    scriptDiv.innerHTML = '';
